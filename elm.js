...
var _user$project$PhotoGroove$BadPayload = F2(
	function (a, b) {
		return {ctor: 'BadPayload', _0: a, _1: b};
	});
var _user$project$PhotoGroove$BadStatus = function (a) {
	return {ctor: 'BadStatus', _0: a};
};
var _user$project$PhotoGroove$NetworkError = {ctor: 'NetworkError'};
var _user$project$PhotoGroove$Timeout = {ctor: 'Timeout'};
var _user$project$PhotoGroove$BadUrl = function (a) {
	return {ctor: 'BadUrl', _0: a};
};
...
var _user$project$PhotoGroove$getPhotoUrl = function (index) {
	var _p4 = A2(_elm_lang$core$Array$get, index, _user$project$PhotoGroove$photoArray);
	if (_p4.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(_p4._0.url);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
